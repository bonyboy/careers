...
(function() {
  ...
  this.PictureTag.Picture = (function() {
    ...
    function Picture($el) {
      var _this = this;
      this.$el = $el;
      this._displayBest = function() {
        return Picture.prototype._displayBest.apply(_this, arguments);
      };
  ...
  this.PictureTag.Img = (function() {
    ...
    function Img(picture) {
      ...
      this._replace = function() {
        return Img.prototype._replace.apply(_this, arguments);
      };
      this._current = function() {
        return Img.prototype._current.apply(_this, arguments);
      };
      this.display = function(value) {
        return Img.prototype.display.apply(_this, arguments);
      };
  ...
  this.PictureTag.Sources = (function() {
    ...
    function Sources($els) {
      var _this = this;
      this.$els = $els;
      this._newSource = function(i, el) {
        return Sources.prototype._newSource.apply(_this, arguments);
      };
      this.best = function() {
        return Sources.prototype.best.apply(_this, arguments);
      };
